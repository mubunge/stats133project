...
lm(formula = Expense_per_ADA ~ PercentProficient, data = star_vs_funding)
...
lm(formula = Expense_per_ADA ~ PercentProficient, data = star_vs_funding_year)

# "Statewide Proficient Percentage vs. Time"
# Year is... the year
# PercentProficient is the percentage of proficient students in the state
lm(formula = Year ~ PercentProficient, data = star_vs_funding_year)
```
